...
<svelte:element this={as} class={twMerge("bg-surface0 p-4 rounded-2xl shadow-lg", cls)} {...rest}>
    <div class="flex flex-col gap-2">
        {#if back || title || action}
            <div class="flex items-center justify-between h-16 mb-2 bg-secondary p-4 rounded-lg">
