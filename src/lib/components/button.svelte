...
<svelte:element this={as} disabled={disabled || loading} {...rest}
                class={twMerge(
                  "bg-surface1 min-w-8 h-8 px-4 rounded-full cursor-pointer hover:bg-primary hover:text-text transition-all flex flex-row gap-2 items-center justify-center",
